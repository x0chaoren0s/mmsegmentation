...
# 测试一张样例图片并得到结果
# img = '../datasets/carvana-image-masking-challenge/val_images/424658d9f222_01.jpg'  # 或者 img = mmcv.imread(img), 这将只加载图像一次．
# result = inference_segmentor(model, img)
# # 在新的窗口里可视化结果
# model.show_result(img, result, show=True)
# # 或者保存图片文件的可视化结果
# # 您可以改变 segmentation map 的不透明度(opacity)，在(0, 1]之间。
# model.show_result(img, result, out_file='results/result.jpg', opacity=0.5)
